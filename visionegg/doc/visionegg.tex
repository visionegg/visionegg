...
\release{0.9.5b1}		% software release, not documentation
\setreleaseinfo{}		% empty for final release
\setshortversion{0.9.5a2}	% major.minor only for software
...
information on the topic of object oriented programming.  You may also
need to consult the documentation for the packages on which the Vision
Egg is based as you write your own scripts.
\end{abstract}
...
Alternatively, you can make use of \class{Presentation}, a class which
maintains an association between parameters of stimuli and their
control functions, calls these functions, and initiates drawing of the
stimuli.  There are several ways to use the \class{Presentation} class
described below.  This mode of operation is useful for

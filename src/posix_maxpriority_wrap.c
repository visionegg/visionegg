...
extern int set_self_policy_priority(int,int);
...
static PyObject *_wrap_set_self_policy_priority(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"ii:set_self_policy_priority",&arg1,&arg2)) goto fail;
    {
        errno = 0;
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"set_self_policy_priority", _wrap_set_self_policy_priority, METH_VARARGS },
	 { (char *)"stop_memory_paging", _wrap_stop_memory_paging, METH_VARARGS },
